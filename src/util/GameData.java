...
public class GameData {
	...
	// Define integers that represent locations within the game
	...
	// Open WGTools and access game memory
	...
	// Probe a specified address
	
	public void probe(long addr, int val) {
		this.tools.writeInt(addr, val);;
	}

	// Applpy a full heal to the character
